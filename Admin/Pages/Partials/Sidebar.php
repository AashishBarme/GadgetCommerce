            ...
            <ul id="sidebarnav" class="p-t-30">
                <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-receipt"></i><span class="hide-menu">Products</span></a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        <li class="sidebar-item"><a href="<?php echo ADMIN_URL; ?>Index.php?page=Products/Add" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">Add Product</span></a></li>
                        <li class="sidebar-item"><a href="<?php echo ADMIN_URL; ?>Index.php?page=Products/List" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu">List Product</span></a></li>
                    </ul>
                </li>
